...
export const SwapCard = memo(({ onTxComplete }) => {
  ...
  const { chains, loading: chainsLoading } = useChains(environment);
  ...
  }, [connected, fromToken, toToken, amount, bothSupported, isRhinoRoute, quoteLoading, quoteError, quote, swapping, handleSwap, handleRhinoSwap, setShowWalletModal]);
